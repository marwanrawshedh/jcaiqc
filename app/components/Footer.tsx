...
function JcsraFooter() {
  return (
    <footer
      ...
      className="bg-[#00234C] pt-12 pb-6 sm:px-10 px-0 font-[sans-serif] tracking-wide"
    >
        ...
        <div className="max-w-screen-xl mx-auto flex sm:flex-nowrap flex-wrap justify-center gap-10">
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-10">
            ...
            <p className="text-lg text-white text-center sm:text-nowrap w-min">
              <strong className="text-lg text-white w-48 text-center">
                Publisher -
              </strong>{" "}
            ...
            <button
              onClick={() =>
                (window.location.href =
                  "https://publish.sciencecommunitypublisher.org/index.php/jcaiqc/login")
              }
              className="py-3 px-8 bg-white text-black text-16 font-medium rounded-lg text-nowrap w-fit"
            >
              Make a Submission
            </button>
            <p className="text-13 text-white opacity-60 text-wrap">
              Hello, we are Science Community Publisher. Our goal is to to
              empower authors and spread there knowledge throw our platform
            </p>
          </div>
        </div>
        ...
        <div className="flex sm:justify-between justify-center items-center flex-wrap gap-4">
          <div className="flex flex-col bg-[rgba(186,215,250,0.2)] w-min p-2 sm:pr-40">
            <a href="https://sciencecommunitypublisher.org/">
              ...
              <p className="text-white text-sm text-center text-nowrap">
                2026© Science Community Publisher. All rights reserved.
              </p>
            </a>
          </div>
          <div className="flex gap-8">
            <Link
              ...
              className="text-white font-medium text-13"
            >
              Privacy
            </Link>
          </div>
        ...
        >
          <p className="text-white flex items-center text-sm">
            ...
            <Image
              width={20}
              height={20}
              className="inline-block h-5 ml-2 align-text-bottom"
...
function MinimalFooter() {
  return (
    <footer
      aria-label="Site Footer"
      className="bg-white border-t border-gray-200 pt-16 pb-8 sm:px-10 px-6 font-body"
    >
      <div className="max-w-screen-xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-gray-500 leading-relaxed max-w-sm">
              Publishing rigorous, peer-reviewed academic research to empower
              authors and spread knowledge globally.
            </p>
            <div className="mt-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/author-guidelines"
                  className="text-gray-500 hover:text-primary transition duration-200 text-sm"
                >
                  For Authors
                </Link>
              </li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="mt-4 py-2.5 px-6 border border-primary text-primary hover:bg-primary hover:text-white transition duration-300 text-sm font-medium w-fit"
            >
              Make a Submission
            </button>
          </div>
        ...
        <div className="border-t border-gray-100 flex flex-col md:flex-row justify-between items-center pt-8 gap-4">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Science Community Publisher. All
            rights reserved.
          </p>
        ...
        <div className="w-full flex justify-center text-center">
          <a
            ...
            target="_blank"
            rel="license noopener noreferrer"
            className="flex items-center gap-2 group text-xs text-gray-400 hover:text-gray-600 transition"
          >
            <span>
              All site content, except where otherwise noted, is licensed under
