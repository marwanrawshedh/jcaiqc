...
export default function RightSideBar() {
  ...
  return (
    <aside
      className="flex flex-col gap-6 sm:w-full h-max"
    ...
    >
      ...
      <div className="flex flex-col gap-3 p-6 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
        ...
        <button
          onClick={() =>
            (window.location.href = isJournalB
              ? "https://submit.journal-b.com"
      ...
      {isJournalB && (
        <section
          aria-labelledby="journal-metrics"
          className="p-6 bg-white border border-gray-200 rounded-xl shadow-sm"
        >
          <h3
            id="journal-metrics"
            className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-4 pb-2 border-b border-gray-100"
          >
            Journal Metrics
          </h3>
      ...
      <section
        aria-labelledby="editorial-leadership"
        className="p-6 bg-white border border-gray-200 rounded-xl shadow-sm"
      >
        <div className="flex items-center justify-between mb-4 pb-2 border-b border-gray-100">
          ...
          <Link
            href="/editorial-team"
            className="text-[10px] font-bold text-accent uppercase hover:underline tracking-wider"
          >
            Full Board
          </Link>
        </div>
